  ...
  const navItems: { to: string; label: string; badge: number; icon?: React.ReactNode }[] = [
    {
      ...
      icon: (
        <svg viewBox="0 0 16 16" className="w-4 h-4 fill-current opacity-65 shrink-0" role="presentation" aria-hidden="true">
    ...
    ...(role === 'admin' || role === 'owner' ? [
      ...
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 256 256" className="w-4 h-4 fill-current opacity-65 shrink-0" role="presentation" aria-hidden="true">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-4 h-4 fill-current opacity-65 shrink-0" role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" aria-hidden="true" focusable="false">
