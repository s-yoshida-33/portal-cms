...
export function ProfileSettings() {
  ...
  const btnClasses = "group flex w-max shrink-0 items-center font-medium select-none border-0 shadow-xs focus:outline-none focus:ring-[var(--accent)]/50 focus-visible:ring-2 focus-visible:ring-[var(--accent)] cursor-pointer disabled:cursor-not-allowed disabled:text-[#797979] bg-[var(--bg-surface)] text-[var(--text)] ring-1 hover:bg-[var(--bg-subtle)] ring-[var(--border)] h-9 gap-1.5 rounded-lg px-3 text-base transition-colors";
  const btnDangerClasses = "group flex w-max shrink-0 items-center font-medium select-none border-0 shadow-xs focus:outline-none focus:ring-[var(--danger-text)]/50 focus-visible:ring-2 focus-visible:ring-[var(--danger-text)] cursor-pointer bg-[var(--danger)] text-[var(--text)] hover:bg-[var(--danger-hover)] ring-1 ring-[var(--danger)] h-9 gap-1.5 rounded-lg px-3 text-base transition-colors";
